...
import 'package:tilawah_app/views/download_widget/download_widget.dart';
            ...
            children: [
              ...
              Directionality(
                ...
                child: Slider(
                  ...
                  activeColor: const Color(0xFF7BE8A6),
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    width: 40,
                    child:
                        QuranPage.currentIndex == currentIndex.toString() &&
                            isPlaying &&
                            showWave
                        ? AudioWave(
                            bars: heightFactors
                                .map(
                                  (heightFactor) => AudioWaveBar(
                  ...
                  DownloadWidget(
                    suraNoDownloading: state.audioList[currentIndex].audio
                        .toString(),
                  ),
                ],
              ),
